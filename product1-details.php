...
<header>
    ...
    <div class="container">
      <img src="images/produkt1.jpg" alt="Product Image" class="product-image">
      <div class="details">
        <h1>BLOND ABSOLU. CONDITIONER FOR BLONDE HAIR.</h1>
        <p>Cmimi: $20</p>
        <p>Ne Stok: <span id="stock">15</span></p>
        ...
        <form id="purchase-form">
          ...
          <div class="form-group">
            ...
            <input type="number" id="quantity" name="quantity" max="15" min="1">
          </div>
